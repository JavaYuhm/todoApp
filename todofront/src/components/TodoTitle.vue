<template>
  <div className="title">
    <p className="title__text">
      <span className="title__message">Good {{ message }},</span>
      <span
    ...
    <p className="title__task">
      <span className="title__task-top">오늘의 할 일은</span>
      <span className="title__task-count">
        <em className="title__task-left">{{ this.todoItemsCount.left }}</em>
        <em
            v-if="this.todoItemsCount.total"
            className="title__task-total"
        >&nbsp;/ {{ this.todoItemsCount.total }}</em>
      </span>
      <span className="title__task-bottom">
        <span v-if="this.todoItemsCount.total > 1"></span>
        <span v-else></span> 입니다 !
      </span>
      <span className="title__task-info"></span>
    </p>
  </div>
</template>
